...
public:
	...
	static void visualizeDescriptor(std::string windowName, cv::Mat desc);
	...
	static ExtendedPoint* addKeypoint(Frame* frame, cv::Point2f point, cv::Mat descriptor, ExtendedPoint::Detector detector);
};
